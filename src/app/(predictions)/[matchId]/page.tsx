  ...
  return (
    <div className="max-w-xl mx-auto">
            ...
            <div className="flex flex-col items-center justify-center w-2/12">
              {isLive ? (
                <div className="text-2xl font-bold">
                  {prediction.teams.home.score} - {prediction.teams.away.score}
                </div>
              ) : (
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-lg bg-gray-50 p-3">
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-sm font-medium">{over15Prob}%</span>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gray-50 p-3">
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-sm font-medium">{over25Prob}%</span>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gray-50 p-3">
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-sm font-medium">{over35Prob}%</span>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-gray-50 p-3">
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-sm font-medium">{bttsProb}%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white shadow-sm border border-gray-100 border-t-0 rounded-b-xl px-4 py-4 mt-4">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-sm mb-1">
            <span className="font-medium">{prediction.stats.possession.home}%</span>
            <span className="text-gray-600">Possession</span>
            <span className="font-medium">{prediction.stats.possession.away}%</span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          ...
          <div className="text-center border-x border-gray-100">
            <div className="text-lg font-bold">{prediction.stats.shots.home.onTarget} - {prediction.stats.shots.away.onTarget}</div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            <div className="text-right w-1/3">
              ...
              <div className="text-xs text-gray-500">({prediction.stats.attacks.home.dangerous} dangerous)</div>
            </div>
            ...
            <div className="w-1/3">
              ...
              <div className="text-xs text-gray-500">({prediction.stats.attacks.away.dangerous} dangerous)</div>
            </div>
          </div>
